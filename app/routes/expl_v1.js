...
router.get('/d2/google-search', function (req, res) {
  ...
  res.render('expl_v1/d2/google-search', {
...
//  process.stdout.write("HAI THERE");
  ...
  res.render('expl_v1/d2/google-results', {
    searchTerm: searchTerm
    });
...
//  process.stdout.write("HAI THERE");
  ...
  res.render('expl_v1/d2/find-a-service', {
    condition: condition,
...
router.get('/d2/check-location', function (req, res) {
  ...
  if (req.query.postcode === '') {
    ...
    res.render('expl_v1/d2/show-list-of-services');
  }
...
router.get('/d2/show-list-of-services', function (req, res) {
  ...
  if (serviceGP == 'true') {
    ...
    var GPData = require('../views/expl_v1/d2/data_files/data_gp_LS.json');
...
//      }
  ...
  if (servicePharmacy == 'true') {
    ...
    var pharmaciesData = require('../views/expl_v1/d2/data_files/data_pharmacies_LS.json');
...
//      }
    ...
    if (serviceSexualHealthClinic == 'true') {
      ...
      var sexualhealthclinicData = require('../views/expl_v1/d2/data_files/data_sexualhealthclinic_LS.json');
...
//  process.stdout.write("HAI THERE");
  ...
  res.render('expl_v1/d2/book-an-appointment-online', {
