...
router.get('/google-search', function (req, res) {
  ...
  res.render('expl_v2/google-search', {
...
//  process.stdout.write("HAI THERE");
  ...
  res.render('expl_v2/google-results', {
    searchTerm: searchTerm
    });
...
//  process.stdout.write("HAI THERE");
  ...
  res.render('expl_v2/find-a-service', {
    condition: condition,
...
router.get('/show-list-of-services', function (req, res) {
  ...
  if (serviceGP == 'true') {
    ...
    var GPData = require('../views/expl_v2/data_files/data_gp_LS.json');
...
//      }
  ...
  if (servicePharmacy == 'true') {
    ...
    var pharmaciesData = require('../views/expl_v2/data_files/data_pharmacies_LS.json');
...
//      }
    ...
    if (serviceSexualHealthClinic == 'true') {
      ...
      var sexualhealthclinicData = require('../views/expl_v2/data_files/data_sexualhealthclinic_LS.json');
  ...
  res.render('expl_v2/show-list-of-services', {
    time: time,
    comment: comment,
...
//  process.stdout.write("HAI THERE");
  ...
  res.render('expl_v2/book-an-appointment-online', {
