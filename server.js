...
var design_sprint_3a = require('./app/routes/design_sprint_3a');
var design_sprint_3b = require('./app/routes/design_sprint_3b');
...
app.use('/design_sprint_3a', design_sprint_3a);
app.use('/design_sprint_3b', design_sprint_3b);
